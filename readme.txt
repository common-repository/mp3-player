...
== Description ==
A mp3 player plugin. Upload mp3 to page gallery and an image. Insert shortag [mp3] 
...
will then have a CLIENT_ID. Go to WordPress backend and find the mp3-player admin page and insert your CLIENT_ID     
...
= Version 1.1 =
* Removed fallback to flash 


= Version 1.0.3 =
* Works now in WP 5.3, and clean up in code
...
= Version 1.0.0 =
* Added 3 different templates, can be found in the admin panel under "Setting/mp3-player"
