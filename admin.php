<?php
    ...
    */
    function mp3_player_save_settings() {
        ...
        $settings['mp3_player_view'] = esc_html( $_POST['mp3_player_view'] );
    ...
    */
    ...
    <table class="form-table">
        ...
        <tr>
            <th><?php _e( 'Mp3 Player Template:', 'mp3-player' ); ?></th>
            <td>
            
            
            <?php
                $settings['mp3_player_view' ];
                
                global $rgMp3playerViews;
                if(!$rgMp3playerViews){
                    die('globalvar $rgMp3playerViews not set in file mp3_player.php');
                }
                
                foreach($rgMp3playerViews as $key=>$view){
                    if( $settings['mp3_player_view' ]==$view){
                        $optionView.='<option selected="selected" value="'.$view.'">'.$key.'</option>';
                    }else{
                        $optionView.='<option value="'.$view.'">'.$key.'</option>';
            ...
            ?>
                <select  id="mp3-player_view" name="mp3_player_view" type="select"    /> 
              <?php
                 echo $optionView;  
               ?>
                </select>
                
                <label for="mp3_player_view"><?php _e( 'Select View Template', 'mp3-player' ); ?></label>
            </td>
        </tr>
